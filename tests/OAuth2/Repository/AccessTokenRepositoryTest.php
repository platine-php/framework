 ...
 * @group framework
 */
class AccessTokenRepositoryTest extends BaseTestRepository
{
    public function testConstruct(): void
    {
        ...
        $o = new AccessTokenRepository($entityManager, $clientService);
        $this->assertInstanceOf(AccessTokenRepository::class, $o);
    }
    ...
    public function testCleanExpiredTokens(): void
    {
        ...
        $entityClass = OauthAccessToken::class;
    ...
    {
        $entity = $this->getMockInstanceMap(OauthAccessToken::class, [
            '__get' => [
                ['scope', ''],
        ...
        $res = $o->getByToken('my_token');
        $this->assertInstanceOf(AccessToken::class, $res);
